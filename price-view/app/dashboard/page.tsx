...
export default function Page() {
  ...
  return (
    <div className="space-y-4 p-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center">Req's Dashboard</h1>

          {/* Search Bar */}
      <div className="flex justify-center">
        <input 
          type="text" 
          placeholder="Search for financial instrument"
          className="w-full max-w-md px-4 py-2 bg-white border border-gray-300 rounded-lg text-black text-sm focus:outline-none focus:border-blue-500"
        />
      </div>
     ...
     <div className="bg-white p-4 rounded-lg border border-gray-200 text-black">
        ...
        <div className="space-y-3">
          <div className="bg-blue-50 p-3 rounded border-1 border-blue-500">
          ...
          <div className="bg-green-50 p-3 rounded border-1 border-green-500">
          ...
          <div className="bg-amber-50 p-3 rounded border-1 border-amber-500">
          ...
          <div className="bg-purple-50 p-3 rounded border-1 border-purple-500">
